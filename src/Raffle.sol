...
contract Raffle is VRFConsumerBaseV2 {
    error Raffle__NotEnoughEthSent(); // Naming convention to know error coming from which contract
    ...
    constructor(
        ...
        uint32 callbackGasLimit //address vrfCoordinatorV2
    ...
    function checkUpkeep(
        ...
        return (upkeepNeeded, "0x0"); //"0x0" -> Empty byte object
    }
    ...
    function fulfillRandomWords(
        ...
        s_lastTimeStamp = block.timestamp;
        emit PickedWinner(winner); // Put it here as it is not Interactions
